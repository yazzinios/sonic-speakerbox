-- ============================================================
-- SonicBeat - Complete Schema Migration
-- Project: iaedzkkysscmzsqccftn
-- ============================================================
...
-- ----------------------------------------
-- Channels table
-- NOTE: No peer_id column — peer IDs are derived from channel codes on the client
-- ----------------------------------------
...
-- Listeners look up channels by code (public read)
